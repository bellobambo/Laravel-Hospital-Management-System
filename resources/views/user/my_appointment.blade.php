...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (Route::has('login'))
                            @auth
                                <li class="nav-item">
                                    <a class="nav-link" style="background-color: lightgreen; color : white;"
    ...
    <div align='center' style="padding:70px">
        <table>
            <tr style="background-color: rgb(46, 104, 60)" >
            ...
            <tr style="background-color: rgb(46, 104, 60)" align="center">
                ...
                <td style="padding:10px; font-size : 20px; color : white "><a class='brn btn-danger' onclick="return confirm('Are You Sure To Delete {{$appoints->doctor}}')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
            </tr>
